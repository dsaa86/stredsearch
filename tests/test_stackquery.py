...
# sys.path.append("/home/matt/Development/Stredsearch/stredsearch/search/custom_functionality")

# from custom_functionality.stackquery import *
...
#         expected_output = [ {"category" : "questions"}, {"category": "answers"}, {"category": "comments"}, {"category": "users"}, {"category": "badges"}, {"category": "tags"}, {"category": "search"} ]

#         assert function_response == expected_output

#         with pytest.raises(TypeError):
#             stackquery.getQueryCategories("input")
